...
import { ArrowRight, BookOpen, Compass, Feather, LogOut, Moon, Plus, Sparkles, Sun, Trash2 } from 'lucide-react';
...
const viewPaths: Record<WorkspaceView, string> = { decisions: '/decisions', patterns: '/patterns', legacy: '/journal', sample: '/sample' };
